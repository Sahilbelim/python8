...
if (((month==3 )and (date>=21 and date<=31) )or((month==4) and (date>=1 and date<=19) )):
...
elif((month==5 and (date>=21 and date<=31)) or (month==6 and (date>=1 and date<=20))):
    print("Zodiac sign is Gemini symbol : the Twins ")

elif((month==6 and (date>=21 and date<=30))or(month==7 and (date>=1 and date<=22))):
