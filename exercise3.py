...
,{
    ...
    "B": "To define an empty code block",
...
,{
    ...
    "A": "Imports a module or a specific function from a module",
    "B": "Exports a module",
    "C": "Prints the output of a module",
    "D": "Deletes a module",
    "ans": "A"
}
,{
    "no": 9,
    "question": "What is the correct way to open a file named 'example.txt' in read mode in Python?",
...
s_questions=random.sample(questions,no)

score=0
for i in range(no):
    Answer=''
    # print(s_s_questions[i])
    print("\n",s_questions[i]['no'],". ",end='')
    print(s_questions[i]['question'])
    print(f"\nA) {s_questions[i]['A']}")
    print(f"\nB) {s_questions[i]['B']}")
    print(f"\nC) {s_questions[i]['C']}")
    print(f"\nD) {s_questions[i]['D']}")
    ...
    print(Answer)
    ans=s_questions[i]['ans']
    if  Answer.upper() == s_questions[i]['ans']:
        score+=1
        print(" Your Ans is correct \n")
        
    else:
        print("\n Your Ans is Wrong  ! ")
        print(f"Write Answer : {s_questions[i]['ans']} ) {s_questions[i][ans]}")
